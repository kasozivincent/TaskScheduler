...
public class WeeklyOnceScheduleTests
{
    ...
    [Test]
    public void WeeklySeries_Monday_Tuesday_Wednesday_Friday()
    {
        var currentDate = new DateTime(2023, 11, 5);
        var schedule = new WeeklyOnceSchedule
        {
        ...
        var series = schedule.WeeklyOnceScheduleSeries(currentDate, 12);
        Assert.That(series, Has.Count.EqualTo(12));
        Assert.Multiple(() =>
        {
            series[0].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 6, 2, 0, 0))));
            series[1].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 7, 2, 0, 0))));
            ...
            series[4].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 27, 2, 0, 0))));
            series[5].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 28, 2, 0, 0))));
            series[6].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 13, 2, 0, 0))));
            series[7].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 15, 2, 0, 0))));
            series[8].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 18, 2, 0, 0))));
            series[9].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 19, 2, 0, 0))));
            series[10].ShouldBeLeft(value => Assert.That(value, Is.EqualTo("Current date is past end date!")));
            series[11].ShouldBeLeft(value => Assert.That(value, Is.EqualTo("Current date is past end date!")));
        });
        
        var description = (string)schedule.GetTaskDescription();
        var expected = $"Occurs every week on Monday, Tuesday, Wednesday and Friday at {new TimeSpan(2, 0, 0)}. Schedule will be used" +
                       $"starting on {new DateTime(2023, 11, 1)}";
    ...
    [Test]
    public void WeeklySeries_Monday_Tuesday_Wednesday_Friday_NoEndDate()
    {
        var currentDate = new DateTime(2023, 11, 5);
        var schedule = new WeeklyOnceSchedule
        {
        ...
        Assert.Multiple(() =>
        {
            ...
            series[8].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 18, 2, 0, 0))));
            series[9].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 19, 2, 0, 0))));
            series[10].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2024, 1, 3, 2, 0, 0))));
            series[11].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2024, 1, 5, 2, 0, 0))));
        });
    ...
    [Test]
    public void WeeklySeries_Monday_Wednesday_Friday_Saturday()
    {
        var currentDate = new DateTime(2023, 11, 5);
        var schedule = new WeeklyOnceSchedule
        {
        ...
        var series = schedule.WeeklyOnceScheduleSeries(currentDate, 11);
        Assert.That(series, Has.Count.EqualTo(11));
        Assert.Multiple(() =>
        {
            series[0].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 6, 2, 0, 0))));
            series[1].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 22, 2, 0, 0))));
            ...
            series[4].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 27, 2, 0, 0))));
            series[5].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 13, 2, 0, 0))));
            series[6].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 15, 2, 0, 0))));
            series[7].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 16, 2, 0, 0))));
            series[8].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 18, 2, 0, 0))));
            series[9].ShouldBeLeft(value => Assert.That(value, Is.EqualTo("Current date is past end date!")));
            series[10].ShouldBeLeft(value => Assert.That(value, Is.EqualTo("Current date is past end date!")));
        });
        ...
        var description = (string)schedule.GetTaskDescription();
        var expected = $"Occurs every week on Monday, Wednesday, Friday and Saturday at {new TimeSpan(2, 0, 0)}. Schedule will be used" +
                       $"starting on {new DateTime(2023, 11, 1)}";
    ...
    [Test]
    public void WeeklySeries_Monday_Wednesday_Friday_Saturday_NoEndDate()
    {
         var currentDate = new DateTime(2023, 11, 5);
        var schedule = new WeeklyOnceSchedule
        {
        ...
        Assert.Multiple(() =>
        {
            ...
            series[7].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 16, 2, 0, 0))));
            series[8].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 18, 2, 0, 0))));
            series[9].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2024, 1, 3, 2, 0, 0))));
            series[10].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2024, 1, 5, 2, 0, 0))));
        });
    ...
    #region Five days
    [Test]
    public void WeeklySeries_Sunday_Monday_Tuesday_Wednesday_Thursday()
    {
        var currentDate = new DateTime(2023, 11, 5);
        var schedule = new WeeklyOnceSchedule
        {
        ...
        var series = schedule.WeeklyOnceScheduleSeries(currentDate, 15);
        Assert.That(series, Has.Count.EqualTo(15));
        Assert.Multiple(() =>
        {
            series[0].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 5, 2, 0, 0))));
            series[1].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 6, 2, 0, 0))));
            series[2].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 7, 2, 0, 0))));
            series[3].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 22, 2, 0, 0))));
            series[4].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 23, 2, 0, 0))));
            series[5].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 26, 2, 0, 0))));
            series[6].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 27, 2, 0, 0))));
            series[7].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 11, 28, 2, 0, 0))));
            series[8].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 13, 2, 0, 0))));
            series[9].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 14, 2, 0, 0))));
            series[10].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 17, 2, 0, 0))));
            series[11].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 18, 2, 0, 0))));
            series[12].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 19, 2, 0, 0))));
            series[13].ShouldBeLeft(value => Assert.That(value, Is.EqualTo("Current date is past end date!")));
            series[14].ShouldBeLeft(value => Assert.That(value, Is.EqualTo("Current date is past end date!")));
        });
        
        var description = (string)schedule.GetTaskDescription();
        var expected = $"Occurs every week on Sunday, Monday, Tuesday, Wednesday and Thursday at {new TimeSpan(2, 0, 0)}. Schedule will be used" +
                       $"starting on {new DateTime(2023, 11, 1)}";
    ...
    [Test]
    public void WeeklySeries_Sunday_Monday_Tuesday_Wednesday_Thursday_NoEndDate()
    {
         var currentDate = new DateTime(2023, 11, 5);
        var schedule = new WeeklyOnceSchedule
        {
        ...
        Assert.Multiple(() =>
        {
            ...
            series[11].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 18, 2, 0, 0))));
            series[12].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2023, 12, 19, 2, 0, 0))));
            series[13].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2024, 1, 3, 2, 0, 0))));
            series[14].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2024, 1, 4, 2, 0, 0))));
        });
