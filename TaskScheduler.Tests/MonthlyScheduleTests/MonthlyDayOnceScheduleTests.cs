...
public class MonthlyDayOnceScheduleTests
{
    ...
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Equal_To_MonthDay_BeforeExecutionTime_NoEndDate()
    {
        var currentDate = new DateTime(2020, 5, 4, 1, 0, 0);
        var monthlyDayOnceSchedule = new MonthlyDayOnceSchedule
        {
        ...
        Assert.Multiple(() =>
        {
            ...
            series[4].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2021, 1, 4, 2, 0, 0))));
            series[5].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2021, 3, 4, 2, 0, 0))));
        });
    }
    
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Equal_To_MonthDay_Equal_To_ExecutionTime()
    {
    ...
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Equal_To_MonthDay_Equal_To_ExecutionTime_NoEndDate()
    {
        var currentDate = new DateTime(2020, 5, 4, 2, 0, 0);
        var monthlyDayOnceSchedule = new MonthlyDayOnceSchedule
        {
        ...
        Assert.Multiple(() =>
        {
            series[0].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2020, 7, 4, 2, 0, 0))));
            series[1].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2020, 9, 4, 2, 0, 0))));
            series[2].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2020, 11, 4, 2, 0, 0))));
            series[3].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2021, 1, 4, 2, 0, 0))));
            series[4].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2021, 3, 4, 2, 0, 0))));
            series[5].ShouldBeRight(value => Assert.That(value, Is.EqualTo(new DateTime(2021, 5, 4, 2, 0, 0))));
        });
    }
    
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Equal_To_MonthDay_After_ExecutionTime()
    {
        var currentDate = new DateTime(2020, 5, 4, 3, 0, 0);
        var monthlyDayOnceSchedule = new MonthlyDayOnceSchedule
        {
            Name = "Send email",
            IsEnabled = true,
    ...
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Equal_To_MonthDay_After_ExecutionTime_NoEndDate()
    {
        var currentDate = new DateTime(2020, 5, 4, 3, 0, 0);
        var monthlyDayOnceSchedule = new MonthlyDayOnceSchedule
        {
    ...
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Not_Equal_To_MonthDay_BeforeExecutionTime()
    {
    ...
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Not_Equal_To_MonthDay_BeforeExecutionTime_NoEndDate()
    {
        var currentDate = new DateTime(2020, 5, 7, 1, 0, 0);
        var monthlyDayOnceSchedule = new MonthlyDayOnceSchedule
        {
    ...
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Not_Equal_To_MonthDay_Equal_To_ExecutionTime()
    {
    ...
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Not_Equal_To_MonthDay_Equal_To_ExecutionTime_NoEndDate()
    {
        var currentDate = new DateTime(2020, 5, 7, 2, 0, 0);
        var monthlyDayOnceSchedule = new MonthlyDayOnceSchedule
        {
    ...
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Not_Equal_To_MonthDay_After_ExecutionTime()
    {
        var currentDate = new DateTime(2020, 5, 7, 3, 0, 0);
        var monthlyDayOnceSchedule = new MonthlyDayOnceSchedule
        {
            Name = "Send email",
            IsEnabled = true,
    ...
    [Test]
    public void SeriesMonthlyDayOnce_CurrentDay_Not_Equal_To_MonthDay_After_ExecutionTime_NoEndDate()
    {
        var currentDate = new DateTime(2020, 5, 7, 3, 0, 0);
        var monthlyDayOnceSchedule = new MonthlyDayOnceSchedule
        {
